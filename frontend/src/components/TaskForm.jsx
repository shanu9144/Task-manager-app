...
const TaskForm = ({ fetchTasks, selectedTask, setSelectedTask }) => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            if (selectedTask) {
                await axios.put(
                    `https://task-manager-app-k08x.onrender.com/api/tasks/${selectedTask._id}`,
                    taskData,
                    config
                );
                setSelectedTask(null);
            } else {
                await axios.post('https://task-manager-app-k08x.onrender.com/api/tasks', taskData, config);
            }
